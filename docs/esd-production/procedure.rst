...
:math:`n(z_s)`. The KiDS implementation of this approach is described in |ref:hildebrandt17|_. Given :math:`n(z_s)`, we calculate
the critical surface density, :math:`\Sigma_\mathrm{c}`, for every lens-source pair, as
