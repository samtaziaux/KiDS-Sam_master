...
def model_bias(theta, R, h=0.7, Om=0.315, Ol=0.685, rmax=2):
    #start = time.time()
    from itertools import count, izip
    np.seterr(divide='ignore', over='ignore', under='ignore', invalid='ignore')
    ...
    sigma_c, alpha_s, A, M_1, gamma_1, gamma_2, b_0, b_1, b_2, alpha_star, beta_gas, r_t0, r_c0, z, M_bin_min1, M_bin_min2, M_bin_min3, M_bin_min4, M_bin_max1, M_bin_max2, M_bin_max3, M_bin_max4, taylor_procedure, include_baryons, smth1, smth2 = theta
    
    M_bin_min = np.log10([M_bin_min1, M_bin_min2, M_bin_min3, M_bin_min4]) # Expanded according to the number of bins!
    M_bin_max = np.log10([M_bin_max1, M_bin_max2, M_bin_max3, M_bin_max4]) # Expanded according to the number of bins!
