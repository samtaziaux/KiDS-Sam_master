...
#config_files = ['ggl_margot.config']

# Edo's age bins
#config_files = ['Edo_logagebins_%i.config'%(i+1) for i in xrange(3)]
#config_files = ['Edo_logagebins.config']
#config_files = ['Edo_logmstarbins.config']
