...
def get_priors(paramfile):
    """
    Read the parameters file and return interp1d objects
    """
    ...
    out = (model, sat_profile, group_profile,
           array(params), array(prior_types), array(starting),
           array(val1), array(val2), array(val3), array(val4),
           array(meta_names), array(fits_format))
    return out
