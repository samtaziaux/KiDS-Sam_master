...
"This utility function calculates the radial diameter distance 'Da' from the redshift 'z' for a given matter and lambda density 'Om' and 'Ol'). Multiplying Da by an opening angle 'theta' on the sky will give its actual size 'x'."
...
def comoving(z,Om,Ol,h):
	...
	# Important constants
	c = const.c.value # Speed of light (in m/s)
	Hdim = h*1e2 # dimension of H (H = h*100km/s/Mpc = h*100*1000m/s/1000kpc = h*100m/s/kpc)
