...
Q0red = 2.12
Q0blue = 0.80
Q0list = np.zeros(len(galIDlist))

colormask_red = (colorlist<0.63)
colormask_blue = (0.63<colorlist)

Q0list[colormask_red] = -Q0red*galZlist[colormask_red]
Q0list[colormask_blue] = -Q0blue*galZlist[colormask_blue]
"""
